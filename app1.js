const BASE_URL =
  "https://v6.exchangerate-api.com/v6/7249c0a206d15256b5889bfd/latest/USD";
...
const updateExchangeRate = async () => {
   ...
   if (amtVal === "" || amtVal < 1) {
    ...
    let f = data.conversion_rates[`${fromCurr.value}`];
    let t = data.conversion_rates[`${toCurr.value}`];
